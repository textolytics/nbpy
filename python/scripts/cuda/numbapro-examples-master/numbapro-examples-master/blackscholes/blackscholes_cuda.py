...
def main (*args):
    ...
    # print("stockPrice |  optionStrike |  optionYears |  callResultCuda |  putResultCuda")
    # print (stockPrice, optionStrike, optionYears, callResultCuda, putResultCuda)
...
#--CPU Calc ----------------------------------------------------------------------------------
    ...
    #                         optionStrike, optionYears, RISKFREE, VOLATILITY)
    #     # print("callResultNumba| putResultNumba | stockPrice |optionStrike | optionYears | RISKFREE | VOLATILITY")
    #     # print (callResultNumba, putResultNumba, stockPrice, optionStrike, optionYears, RISKFREE, VOLATILITY)
    # time1 = time.time()
    ...
    time1 = time.time()
    print("d_callResult |  d_putResult |  d_stockPrice |  d_optionStrike |  d_optionYears |  RISKFREE |  VOLATILITY")

    for i in range(iterations):
        black_scholes_cuda[griddim, blockdim, stream](
            d_callResult, d_putResult, d_stockPrice, d_optionStrike,
            d_optionYears, RISKFREE, VOLATILITY)
        print (d_callResult[i], d_putResult[i], d_stockPrice[i], d_optionStrike[i], d_optionYears[i], RISKFREE, VOLATILITY)
