...
while True:
    ...
    if float(spread_t_bid) < 0:
            ...
            if instrument_t1[-3:] == "EUR":
                print("BASKET","EURUSD ASK:", kraken_EURUSD_ASK_5_t0, "SELL",instrument_t0, bid_t0,"BUY", instrument_t0_cross, instrument_t0_cross_ask, "EURUSD BID:",kraken_EURUSD_BID_5_t1,"BUY", instrument_t1, ask_t1,"SELL", instrument_t1_cross, instrument_t1_cross_bid  )
            basket_json = [
                {
                    "measurement": 'MESSAGES',
                    "tags": {
